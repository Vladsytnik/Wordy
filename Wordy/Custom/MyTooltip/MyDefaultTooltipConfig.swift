...
public struct MyDefaultTooltipConfig: MyTooltipConfig {
	static var shared = MyDefaultTooltipConfig()
	
	public var side: MyTooltipSide = .bottom
	...
	public init(side: MyTooltipSide) {
		self.side = side
	}
}
